...
nohup $SPARK_HOME/bin/spark-submit --master local[*] --jars /home/ec2-user/models/analytics-framework-0.5.jar --class org.ekstep.analytics.job.AserScreenSummarizer /home/ec2-user/models/batch-models-1.0.jar --config "$aser_config" > "logs/$endDate-aser-ss.log" 2>&1&