...
nohup $SPARK_HOME/bin/spark-submit --master local[*] --jars /home/ec2-user/models/analytics-framework-0.5.jar --class org.ekstep.analytics.job.LearnerActivitySummarizer /home/ec2-user/models/batch-models-1.0.jar --config "$la_config" > "logs/$endDate-la-summ.log" 2>&1&