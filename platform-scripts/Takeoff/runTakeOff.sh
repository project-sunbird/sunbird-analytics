...
# basepath = your_path/github/ekStep/Learning-Platform-Analytics
basepath = $1
runFramework=$1
runBatchmodel=$2
cleanTables=$3
...
scriptDir=$basePath/platform-scripts
...
echo "writing raw/ss data to local files for offline analysis"
# 
...
spark-shell -i $scriptDir/Takeoff/runTakeoff.scala --jars $modelJar,$fwJar -driver-memory 4G --executor-memory 8G --executor-cores 4 
