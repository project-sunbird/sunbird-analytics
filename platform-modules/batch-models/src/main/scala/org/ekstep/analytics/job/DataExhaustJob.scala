        ...
        val jobResponses = for (request <- requests) yield {
            ...
            try {
                ...
                val requestConfig = Map(
                    ...
                    "data-exhaust-bucket" -> modelConfig.getOrElse("data-exhaust-bucket", "lpdev-ekstep"),
                    "data-exhaust-prefix" -> modelConfig.getOrElse("data-exhaust-prefix", "data-exhaust/dev"),
