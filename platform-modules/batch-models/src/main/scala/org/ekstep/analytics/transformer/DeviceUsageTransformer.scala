...
object DeviceUsageTransformer extends DeviceRecommendationTransformer[DeviceUsageSummary, dus_tf] {
    ...
    override def getTransformationByBinning(rdd: RDD[DeviceUsageSummary],  num_bins: Int)(implicit sc: SparkContext): RDD[(String, dus_tf)] = {
