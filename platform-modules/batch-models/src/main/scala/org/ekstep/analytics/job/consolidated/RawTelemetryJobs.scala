...
object RawTelemetryJobs extends optional.Application with IJob {
    ...
    def main(config: String)(implicit sc: Option[SparkContext] = None) {
        val models = List(LearnerSessionSummaryModel, GenieLaunchSummaryModel, GenieSessionSummaryModel, ContentSideloadingSummaryModel, ContentPopularitySummaryModel, GenieFunnelModel, EOCRecommendationFunnelModel)
