...
object RawTelemetryJobs extends optional.Application with IJob {
    ...
    def main(config: String)(implicit sc: Option[SparkContext] = None) {
        val models = List(LearnerSessionSummaryModel, AserScreenSummaryModel, GenieLaunchSummaryModel, GenieSessionSummaryModel, ContentSideloadingSummaryModel, ContentPopularitySummaryModel, GenieFunnelModel, EOCRecommendationFunnelModel)
