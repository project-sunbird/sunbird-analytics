...
trait MetricsBatchModel[T, R] extends IBatchModel[T, R] {
    ...
    def getMeasuredEvent[T <: CassandraTable](eid: String, syncts: Long, mid: String, channel: String, modelName: String, metrics: Map[String, AnyRef], dimension: Dimensions): MeasuredEvent = {

        MeasuredEvent(eid, System.currentTimeMillis(), syncts, "1.0", mid, "", channel, None, None,
