...
case class WorkFlowSummaryIndex(d_period: Int,d_channel: String,d_app_id: String,d_tag: String,d_type: String,d_device_id: String,d_content_id: String,d_user_id: String)
case class WorkFlowUsageSummaryFact(d_period: Int,d_channel: String,d_app_id: String,d_tag: String,d_type: String,d_device_id: String,d_content_id: String,d_user_id: String, total_ts: Double,total_sessions: Long,avg_ts_session: Double,total_interactions: Long,avg_interactions_min: Double,total_pageviews_count: Long,avg_pageviews: Double,total_users_count: Long,total_content_count: Long,total_devices_count: Long,unique_users: Array[Byte],device_ids: Array[Byte],contents: Array[Byte])
