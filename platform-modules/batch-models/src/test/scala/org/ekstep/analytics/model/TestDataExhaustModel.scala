...
class TestDataExhaustModel extends SparkSpec(null) {
    ...
    ignore should "generate zip file of all events and save to s3" in {
        ...
        val rdd2 = DataExhaustModel.execute(rdd, Option(Map("request_id" -> "6a54bfa283de43a89086e69e2efdc9eb6750493d", "tag" -> List("6da8fa317798fd23e6d30cdb3b7aef10c7e7bef5"))));
        
        val table = sc.cassandraTable[JobSummary]("general_db", "jobs").where("request_id=?", "6a54bfa283de43a89086e69e2efdc9eb6750493d").first
        table.output_events should be(100)
    ...
    ignore should "generate zip file of only assessment events and save to s3" in {
        ...
        val rdd2 = DataExhaustModel.execute(rdd, Option(Map("request_id" -> "4a54bfa283de43a89086e69e2efdc9eb6750493d", "tag" -> List("6da8fa317798fd23e6d30cdb3b7aef10c7e7bef5"))));
        
        val table = sc.cassandraTable[JobSummary]("general_db", "jobs").where("request_id=?", "4a54bfa283de43a89086e69e2efdc9eb6750493d").first
        table.output_events should be(50)
        table.status should be("COMPLETED")
    }
    ...
    ignore should "check for given filter criteria that no data available" in {
        ...
        val rdd2 = DataExhaustModel.execute(rdd, Option(Map("request_id" -> "8a54bfa283de43a89086e69e2efdc9eb6750493d", "tag" -> List("6da8fa317798fd23e6d30cdb3b7aef10c7e7bef5"))));
        
        val table = sc.cassandraTable[JobSummary]("general_db", "jobs").where("request_id=?", "4a54bfa283de43a89086e69e2efdc9eb6750493d").first
        table.output_events should be(0)
        table.status should be("COMPLETED")
    ...
    def populateCassandra() {
        ...
        val input = sc.parallelize(Array(("6a54bfa283de43a89086e69e2efdc9eb6750493d", "dataexhaust", "SUBMITTED"),("4a54bfa283de43a89086e69e2efdc9eb6750493d", "dataexhaust", "SUBMITTED"),("8a54bfa283de43a89086e69e2efdc9eb6750493d", "dataexhaust", "SUBMITTED")));
