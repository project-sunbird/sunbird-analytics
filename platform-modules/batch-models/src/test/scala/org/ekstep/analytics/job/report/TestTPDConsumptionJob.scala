...
class TestTPDConsumptionJob extends SparkSpec(null) {

  "TPDConsumptionMetricsJob" should "execute the job and won't throw any error" in {
    ...
    TPDConsumptionMetricsJob.main(JSONUtils.serialize(jobConfig))(Option(sc))
  }
}
