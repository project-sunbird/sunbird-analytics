 ...
 * @author Santhosh
 */
class TestGenericSessionSummaryV2 extends SparkSpec(null) {
    ...
    it should "generate 4 session summarries and pass all negative test cases" in {
        ...
        val rdd2 = GenericSessionSummaryV2.execute(sc, rdd, Option(Map("modelVersion" -> "1.2", "modelId" -> "GenericContentSummary")));
        val me = rdd2.collect();
