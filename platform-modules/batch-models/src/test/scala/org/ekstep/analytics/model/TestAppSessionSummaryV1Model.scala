...
class TestAppSessionSummaryV1Model extends SparkSpec(null) {

    "AppSessionSummaryV1Model" should "generate 1 app session summary events having CE_START & CE_END" in {

        val rdd1 = loadFile[CreationEvent]("src/test/resources/portal-session-summary/test_data_1.log");
        val rdd2 = AppSessionSummaryV1Model.execute(rdd1, None);
        val me = rdd2.collect();
