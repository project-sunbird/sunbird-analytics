 ...
 * @author Santhosh
 */
class TestUpdateLearnerProfileDB extends SparkSpec(null) {
    ...
    "UpdateLearnerProfileDB" should "update learner profile in learner db" in {
        ...
        val profile2 = sc.cassandraTable[LearnerProfile]("local_learner_db", "learnerprofile").where("learner_id = ?", "1aca2342-3865-4f67-aff5-048027cba8b1").first();
        ...
        val profile3 = sc.cassandraTable[LearnerProfile]("local_learner_db", "learnerprofile").where("learner_id = ?", "f770ee2c-2e2a-48fc-890b-8634718ae003").first();
