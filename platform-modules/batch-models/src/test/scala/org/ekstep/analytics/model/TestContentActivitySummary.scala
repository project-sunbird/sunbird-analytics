...
class TestContentActivitySummary extends SparkSpec(null) {
    ...
    "ContentSummary" should "generate contentsummary and pass all positive test cases" in {
        ...
        val rdd = loadFile[DerivedEvent]("src/test/resources/content-summary/test_data_1.log");
        ...
        val rdd2 = loadFile[DerivedEvent]("src/test/resources/content-summary/test_data_2.log");
        ...
        val rdd3 = loadFile[DerivedEvent]("src/test/resources/content-summary/test_data_3.log");
    ...
    it should "generate contentsummary for more than 5 content, those are not Collection type" in {
        val rdd = loadFile[DerivedEvent]("src/test/resources/content-summary/test_data_4.log");
        val me = ContentActivitySummary.execute(rdd, None).collect;
    }
}