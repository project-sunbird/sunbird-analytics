...
class TestUpdateContentEditorUsageDB extends SparkSpec(null) {
    ...
    "UpdateContentEditorUsageDB" should "update the content editor usage db and check the fields" in {
        ...
        */ 
        ...
        cummAllCESumm.avg_time_spent should be(16.0)
        ...
        */ 
        ...
        cummAllCESumm1.avg_time_spent should be(6.0)
        ...
        */ 
        ...
        cummAllCESumm2.avg_time_spent should be(6.0)
        ...
        */ 
        ...
        cummAllCESumm3.avg_time_spent should be(16.0)
    }
