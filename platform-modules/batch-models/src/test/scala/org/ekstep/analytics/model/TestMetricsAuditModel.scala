...
class TestMetricsAuditModel extends SparkSpec(null) with MockFactory{
  ...
  "TestMetricsAuditJob" should "get the metrics for monitoring the data pipeline" in {
    val modelParams = "{\"search\":{\"type\":\"none\"},\"model\":\"org.ekstep.analytics.model.MetricsAuditJob\",\"modelParams\":{\"auditConfig\":{\"druid\":{\"models\":{\"telemetry-events\":{\"query\":\"druid.telemetryDatasource.count.query\"},\"summary-events\":{\"query\":\"druid.summaryDatasource.count.query\"}}},\"secor\":{\"models\":{\"channel\":{\"search\":{\"type\":\"secor\",\"queries\":[{\"bucket\":\"dev-data-store\",\"prefix\":\"raw/\",\"startDate\":\"2019-11-06\",\"endDate\":\"2019-11-06\"}]}},\"denorm\":{\"search\":{\"type\":\"secor\",\"queries\":[{\"bucket\":\"dev-data-store\",\"prefix\":\"telemetry-denormalized/raw/\",\"startDate\":\"2019-11-06\",\"endDate\":\"2019-11-06\"}]}},\"failed\":{\"search\":{\"type\":\"secor\",\"queries\":[{\"bucket\":\"dev-data-store\",\"prefix\":\"failed/\",\"startDate\":\"2019-11-06\",\"endDate\":\"2019-11-06\"}]}}}}}},\"output\":[{\"to\":\"kafka\",\"params\":{\"brokerList\":\"localhost:9092\",\"topic\":\"metrics.topic\"}}],\"parallelization\":8,\"appName\":\"Metrics Audit\"}"
    val config = JSONUtils.deserialize[JobConfig](modelParams)
  ...
  "TestMetricsAuditJob" should "provide the result for the secor metrics" in {
