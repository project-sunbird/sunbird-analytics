...
import org.scalamock.scalatest.MockFactory
  ...
  class TestMetricsAuditModel extends SparkSpec(null) with MockFactory{
    ...
    "TestMetricsAuditJob" should "get the metrics for monitoring the data pipeline" in {
      val auditConfig = "{\"search\":{\"type\":\"none\"},\"model\":\"org.ekstep.analytics.model.MetricsAuditJob\",\"modelParams\":{\"auditConfig\":[{\"name\":\"denorm\",\"search\":{\"type\":\"local\",\"queries\":[{\"file\":\"src/test/resources/audit-metrics-report/denorm/2019-12-03-1575312964601.json.gz\"}]},\"filters\":[{\"name\":\"flags.user_data_retrieved\",\"operator\":\"EQ\",\"value\":true},{\"name\":\"flags.content_data_retrieved\",\"operator\":\"EQ\",\"value\":true},{\"name\":\"flags.device_data_retrieved\",\"operator\":\"EQ\",\"value\":true},{\"name\":\"flags.dialcode_data_retrieved\",\"operator\":\"EQ\",\"value\":true},{\"name\":\"flags.collection_data_retrieved\",\"operator\":\"EQ\",\"value\":true},{\"name\":\"flags.derived_location_retrieved\",\"operator\":\"EQ\",\"value\":true}]},{\"name\":\"raw\",\"search\":{\"type\":\"local\",\"queries\":[{\"file\":\"src/test/resources/audit-metrics-report/raw/raw.json.gz\"}]}},{\"name\":\"failed\",\"search\":{\"type\":\"local\",\"queries\":[{\"file\":\"src/test/resources/audit-metrics-report/failed/2019-12-04-1575420457646.json.gz\"}]}},{\"name\":\"channel-raw\",\"search\":{\"type\":\"local\",\"queries\":[{\"file\":\"src/test/resources/audit-metrics-report/channel-raw/2019-12-04-1575399627832.json.gz\"}]}},{\"name\":\"channel-summary\",\"search\":{\"type\":\"local\",\"queries\":[{\"file\":\"src/test/resources/audit-metrics-report/channel-summary/2019-12-04-1575510009570.json.gz\"}]}},{\"name\":\"derived\",\"search\":{\"type\":\"local\",\"queries\":[{\"file\":\"src/test/resources/audit-metrics-report/derived/2018-08-22-1534985876397.json.gz\"}]}},{\"name\":\"telemetry-count\",\"search\":{\"type\":\"druid\",\"druidQuery\":{\"queryType\":\"timeSeries\",\"dataSource\":\"telemetry-events\",\"intervals\":\"LastDay\",\"aggregations\":[{\"name\":\"total_count\",\"type\":\"count\",\"fieldName\":\"count\"}],\"descending\":\"false\"}}},{\"name\":\"summary-count\",\"search\":{\"type\":\"druid\",\"druidQuery\":{\"queryType\":\"timeSeries\",\"dataSource\":\"summary-events\",\"intervals\":\"LastDay\",\"aggregations\":[{\"name\":\"total_count\",\"type\":\"count\",\"fieldName\":\"count\"}],\"descending\":\"false\"}}}]},\"output\":[{\"to\":\"file\",\"params\":{\"file\":\"src/test/resources/audit-metrics-result\"}}],\"parallelization\":8,\"appName\":\"Metrics Audit\"}"
    ...
    it should "execute MetricsAudit job and won't throw any Exception" in {
      val configString ="{\"search\":{\"type\":\"none\"},\"model\":\"org.ekstep.analytics.model.MetricsAuditJob\",\"modelParams\":{\"auditConfig\":[{\"name\":\"denorm\",\"search\":{\"type\":\"local\",\"queries\":[{\"file\":\"src/test/resources/audit-metrics-report/denorm/2019-12-03-1575312964601.json.gz\"}]},\"filters\":[{\"name\":\"flags.user_data_retrieved\",\"operator\":\"EQ\",\"value\":true},{\"name\":\"flags.content_data_retrieved\",\"operator\":\"EQ\",\"value\":true},{\"name\":\"flags.device_data_retrieved\",\"operator\":\"EQ\",\"value\":true},{\"name\":\"flags.dialcode_data_retrieved\",\"operator\":\"EQ\",\"value\":true},{\"name\":\"flags.collection_data_retrieved\",\"operator\":\"EQ\",\"value\":true},{\"name\":\"flags.derived_location_retrieved\",\"operator\":\"EQ\",\"value\":true}]},{\"name\":\"raw\",\"search\":{\"type\":\"local\",\"queries\":[{\"file\":\"src/test/resources/audit-metrics-report/raw/raw.json.gz\"}]}},{\"name\":\"telemetry-count\",\"search\":{\"type\":\"druid\",\"druidQuery\":{\"queryType\":\"timeSeries\",\"dataSource\":\"telemetry-events\",\"intervals\":\"LastDay\",\"aggregations\":[{\"name\":\"total_count\",\"type\":\"count\",\"fieldName\":\"count\"}],\"descending\":\"false\"}}},{\"name\":\"summary-count\",\"search\":{\"type\":\"druid\",\"druidQuery\":{\"queryType\":\"timeSeries\",\"dataSource\":\"summary-events\",\"intervals\":\"LastDay\",\"aggregations\":[{\"name\":\"total_count\",\"type\":\"count\",\"fieldName\":\"count\"}],\"descending\":\"false\"}}}]},\"output\":[{\"to\":\"file\",\"params\":{\"file\":\"src/test/resources/audit-metrics-result\"}}],\"parallelization\":8,\"appName\":\"Metrics Audit\"}"
    ...
    it should "load the local file and give the count for other files than failed/denorm" in {
      val auditConfig = "{\"search\":{\"type\":\"none\"},\"model\":\"org.ekstep.analytics.model.MetricsAuditJob\",\"modelParams\":{\"auditConfig\":[{\"name\":\"raw\",\"search\":{\"type\":\"local\",\"queries\":[{\"file\":\"src/test/resources/audit-metrics-report/raw/raw.json.gz\"}]}}]},\"output\":[{\"to\":\"file\",\"params\":{\"file\":\"src/test/resources/audit-metrics-result\"}}],\"parallelization\":8,\"appName\":\"Metrics Audit\"}"
      val config = Fetcher("local", None, Option(Array(Query(None, None, None, None, None, None, None, None, None, Option("src/test/resources/audit-metrics-report/raw/raw.json.gz")))))
    ...
    it should "load failed files from local and give the count for failed backup" in {
      val config = Fetcher("local", None, Option(Array(Query(None, None, None, None, None, None, None, None, None, Option("src/test/resources/audit-metrics-report/failed/2019-12-04-1575420457646.json.gz")))))
