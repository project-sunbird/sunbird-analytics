...
class TestGenericSessionSummarizer extends BaseSpec {
    ...
    it should "execute GenericSessionSummarizer job and won't throw any Exception" in {
        ...
        val config = JobConfig(Fetcher("local", None, Option(Array(Query(None, None, None, None, None, None, None, None, None, Option("src/test/resources/session-summary/test_data1.log"))))), null, null, "org.ekstep.analytics.model.GenericSessionSummary", null, Option(Array(Dispatcher("console", Map("printEvent" -> false.asInstanceOf[AnyRef])))), Option(10), Option("TestGenericSessionSummarizer"), Option(false))
