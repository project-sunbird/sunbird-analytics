...
class TestUpdateAppObjectCacheDB extends SparkSpec(null) {
    ...
    "UpdateAppObjectCacheDB" should "create app object cache in creation db" in {
        ...
        object1.prevstate.get should be ("");
        ...
        object2.prevstate.get should be ("");
    ...
    it should "update app object cache in creation db" in {
        ...
        object1.prevstate.get should be ("Create");
        ...
        object2.prevstate.get should be ("Create");
        ...
        object3.prevstate.get should be ("Create");
    ...
    it should "create platform object cache in creation db" in {
        ...
        object1.subtype.get should be ("TextBookUnit");
        ...
        object2.subtype.get should be ("Story");
        ...
        object2.prevstate.get should be ("Draft");
