...
class TestDeviceRecommendationScoringModel extends SparkSpec(null) {
    ...
    "DeviceRecommendationScoringModel" should "load model and generate scores" in {
        ...
        populateCassandra();
        DeviceRecommendationTrainingModel.execute(null, Option(Map("trainRatio" -> Double.box(0.5), "testRatio" -> Double.box(0.5))))
    ...
    it should "load model with zero pairwise interactions and generate scores" in {
        ...
        populateCassandra();
        val jobParams2 = Map("libFMTrainConfig" -> "-dim 1,1,10 -iter 100 -method sgd -task r -regular 3,10,10 -learn_rate 0.01 -seed 100 -init_stdev 100", "trainRatio" -> Double.box(0.5), "testRatio" -> Double.box(0.5))
    ...
    it should "load model with zero W0 and generate scores" in {
        ...
        populateCassandra();
        val jobParams3 = Map("libFMTrainConfig" -> "-dim 0,1,5 -iter 100 -method sgd -task r -regular 3,10,10 -learn_rate 0.01 -seed 100 -init_stdev 100", "trainRatio" -> Double.box(0.5), "testRatio" -> Double.box(0.5))
    ...
    it should "load model with zero unary interactions and generate scores" in {
        ...
        populateCassandra();
        val jobParams4 = Map("libFMTrainConfig" -> "-dim 1,0,10 -iter 100 -method sgd -task r -regular 3,10,10 -learn_rate 0.01 -seed 100 -init_stdev 100", "trainRatio" -> Double.box(0.5), "testRatio" -> Double.box(0.5))
