...
class TestDeviceRecommendationScoringModel extends SparkSpec(null) {
    ...
    def deleteCreatedTestFiles() {
        CommonUtil.deleteFile("src/test/resources/device-reco/train.dat.libfm");
        CommonUtil.deleteFile("src/test/resources/device-reco/test.dat.libfm");
        CommonUtil.deleteFile("src/test/resources/device-reco/fm.model");
        CommonUtil.deleteDirectory("src/test/resources/device-reco/RE-input");
    }
