...
class TestUpdatePublishPipelineSummary extends SparkSpec(null) {
  ...
  "UpdatePublishPipelineSummary" should "update the content_publish_fact table for DAY, WEEK, MONTH, YEAR" in {
    ...
    val daywiseSummary20170523 = sc.cassandraTable[PublishPipelineSummaryFact](Constants.CREATION_METRICS_KEY_SPACE_NAME, Constants.PUBLISH_PIPELINE_SUMMARY_FACT).where("d_period=?", 20170523).collect
    ...
    val daywiseSummary20170524 = sc.cassandraTable[PublishPipelineSummaryFact](Constants.CREATION_METRICS_KEY_SPACE_NAME, Constants.PUBLISH_PIPELINE_SUMMARY_FACT).where("d_period=?", 20170524).collect
    ...
    val daywiseSummary20170525 = sc.cassandraTable[PublishPipelineSummaryFact](Constants.CREATION_METRICS_KEY_SPACE_NAME, Constants.PUBLISH_PIPELINE_SUMMARY_FACT).where("d_period=?", 20170525).collect
    ...
    val weekwiseSummary = sc.cassandraTable[PublishPipelineSummaryFact](Constants.CREATION_METRICS_KEY_SPACE_NAME, Constants.PUBLISH_PIPELINE_SUMMARY_FACT).where("d_period=?", 2017721).collect
    ...
    val monthwiseSummary201704 = sc.cassandraTable[PublishPipelineSummaryFact](Constants.CREATION_METRICS_KEY_SPACE_NAME, Constants.PUBLISH_PIPELINE_SUMMARY_FACT).where("d_period=?", 201704).collect
    ...
    //
    val cumulativeSummary = sc.cassandraTable[PublishPipelineSummaryFact](Constants.CREATION_METRICS_KEY_SPACE_NAME, Constants.PUBLISH_PIPELINE_SUMMARY_FACT).where("d_period=?", 0).collect
