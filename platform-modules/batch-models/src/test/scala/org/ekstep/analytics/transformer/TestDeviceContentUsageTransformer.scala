...
class TestDeviceContentUsageTransformer extends SparkSpec(null) {
    ...
    "DeviceContentUsageTransformer" should "perform binning and outlier on DCUS" in {
        ...
        CassandraConnector(sc.getConf).withSessionDo { session =>
            ...
            session.execute("INSERT INTO local_device_db.device_content_summary_fact(device_id, content_id, app_id, channel, avg_interactions_min, downloaded, game_ver, mean_play_time_interval, total_timespent) VALUES ('9ea6702483ff7d4fcf9cb886d0ff0e1ebc25a034', 'domain_63840','Genie','Ekstep', null, true, null, 1, 1234);");
