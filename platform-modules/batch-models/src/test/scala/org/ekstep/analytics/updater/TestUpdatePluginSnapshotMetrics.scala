...
import org.ekstep.analytics.updater.UpdatePluginSnapshotMetrics
...
class TestUpdatePluginSnapshotMetrics extends SparkGraphSpec(null) {
    //-----test1-------
    ...
    "PluginSnapshotMetric" should "generate All plugin matrix data" in {
        ...
        UpdatePluginSnapshotMetrics.execute(sc.makeRDD(List(Empty())), None)
