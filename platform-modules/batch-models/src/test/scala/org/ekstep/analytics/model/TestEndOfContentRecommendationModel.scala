...
class TestEndOfContentRecommendationModel extends SparkSpec(null) {
    ...
    def populateDatabase() {
        ...
        CassandraConnector(sc.getConf).withSessionDo { session =>
            ...
            session.execute("INSERT INTO content_db.content_sideloading_summary(content_id, app_id, channel, num_downloads, total_count, num_sideloads, origin_map, avg_depth) VALUES ('domain_64106', 'Genie', 'Ekstep', 1000000, 15, 5, {}, 0.5);");
            session.execute("INSERT INTO content_db.content_sideloading_summary(content_id, app_id, channel, num_downloads, total_count, num_sideloads, origin_map, avg_depth) VALUES ('org.ekstep.ms_52d02eae69702d0905cf0800', 'Genie', 'Ekstep', 50, 15, 5, {}, 0.5);");
            session.execute("INSERT INTO content_db.content_sideloading_summary(content_id, app_id, channel, num_downloads, total_count, num_sideloads, origin_map, avg_depth) VALUES ('domain_48661', 'Genie', 'Ekstep', 100, 15, 5, {}, 0.5);");
            session.execute("INSERT INTO content_db.content_sideloading_summary(content_id, app_id, channel, num_downloads, total_count, num_sideloads, origin_map, avg_depth) VALUES ('domain_55065', 'Genie', 'Ekstep', 1000, 15, 5, {}, 0.5);");
            session.execute("INSERT INTO content_db.content_sideloading_summary(content_id, app_id, channel, num_downloads, total_count, num_sideloads, origin_map, avg_depth) VALUES ('domain_70615', 'Genie', 'Ekstep', 50000, 15, 5, {}, 0.5);");
            session.execute("INSERT INTO content_db.content_sideloading_summary(content_id, app_id, channel, num_downloads, total_count, num_sideloads, origin_map, avg_depth) VALUES ('org.ekstep.aser', 'Genie', 'Ekstep', 1, 15, 5, {}, 0.5);");
            session.execute("INSERT INTO content_db.content_popularity_summary_fact(d_period, d_tag, d_content_id, d_app_id, d_channel, m_downloads, m_side_loads, m_comments, m_ratings, m_avg_rating) VALUES (0, 'all' ,'domain_64106', 'Genie', 'Ekstep', 10, 0, [], [], 4.8);");
        }
    }
}