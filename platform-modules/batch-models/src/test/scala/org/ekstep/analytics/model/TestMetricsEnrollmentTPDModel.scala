...
import org.ekstep.analytics.job.report.MetricsEnrollmentTPDJob
import org.scalamock.scalatest.MockFactory
import org.scalatest.Matchers

class TestMetricsEnrollmentTPDModel extends SparkSpec with Matchers with MockFactory {

  implicit val fc = new FrameworkContext()

  it should "generate result for course enrollment tpd report" in {
    ...
    MetricsEnrollmentTPDModel.execute(sc.emptyRDD, Option(modelParams))
  }
