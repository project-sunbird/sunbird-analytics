...
class TestGenieFunnelModel extends SparkSpec(null) {
    ...
    it should "generates funnel summary, from a data having one funnel in each session" in {
        ...
        eksMap1.contains("contentPlayed") should be (false)
    }
