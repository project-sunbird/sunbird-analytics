...
class TestDeviceUsageTransformer extends SparkSpec(null) {
    ...
    "DeviceUsageTransformer" should "perform binning and outlier on DUS and device_spec" in {
        ...
        CassandraConnector(sc.getConf).withSessionDo { session =>
            ...
            session.execute("INSERT INTO local_device_db.device_usage_summary(device_id, app_id, channel, avg_num_launches, avg_time, end_time, last_played_content, last_played_on, mean_play_time, mean_play_time_interval, num_contents, num_days, num_sessions, play_start_time, start_time, total_launches, total_play_time, total_timespent) VALUES ('9ea6702483ff7d4fcf9cb886d0ff0e1ebc25a036', 'Genie', 'Ekstep', 0.01, 0.07, 1459641600, 'domain_68601', 1461715199, 10, 0, 2, 410, 1, 1459641600, 1459641600, 3, 10, 30);");
            session.execute("INSERT INTO local_device_db.device_usage_summary(device_id, app_id, channel, avg_num_launches, avg_time, end_time, last_played_content, last_played_on, mean_play_time, mean_play_time_interval, num_contents, num_days, num_sessions, play_start_time, start_time, total_launches, total_play_time, total_timespent) VALUES ('9ea6702483ff7d4fcf9cb886d0ff0e1ebc25a043', 'Genie', 'Ekstep', 0.01, 0.07, 1459641600, '', 1461715199, 10, 0, 2, 410, 1, 1459641600, 1459641600, 3, 10, 30);");
            session.execute("INSERT INTO local_device_db.device_usage_summary(device_id, app_id, channel, avg_num_launches, avg_time, last_played_content, mean_play_time, mean_play_time_interval, total_play_time, total_timespent) VALUES ('9ea6702483ff7d4fcf9cb886d0ff0e1ebc25a044', 'Genie', 'Ekstep', 0.01, 0.07, '', 10, 0, 10, 30);");
    ...
    it should "perform one-hot-encoding on device-spec" in {
        ...
        CassandraConnector(sc.getConf).withSessionDo { session =>
            ...
            session.execute("INSERT INTO local_device_db.device_specification(device_id, app_id, channel, os, screen_size, capabilities, cpu, device_local_name, device_name, external_disk, internal_disk, make, memory, num_sims, primary_secondary_camera) VALUES ('9ea6702483ff7d4fcf9cb886d0ff0e1ebc25a044', 'Genie', 'Ekstep', 'Android 5.0.1', 5.7, [''], 'abi: armeabi-v7a  ARMv7 Processor rev 4 (v7l)', '', '', 1.13, 835.78, 'SamsungS685', -1, 1, '5.0');");
            session.execute("INSERT INTO local_device_db.device_specification(device_id, app_id, channel, os, screen_size, capabilities, cpu, device_local_name, device_name, external_disk, internal_disk, make, memory, num_sims, primary_secondary_camera) VALUES ('8ea6702483ff7d4fcf9cb886d0ff0e1ebc25a044', 'Genie', 'Ekstep', 'Android 5.0.1', 5.7, [''], 'abi: armeabi-v7a  ARMv7 Processor rev 4 (v7l)', '', '', 1.13, 835.78, 'Samsung J5', -1, 1, ' , ');");
        }
