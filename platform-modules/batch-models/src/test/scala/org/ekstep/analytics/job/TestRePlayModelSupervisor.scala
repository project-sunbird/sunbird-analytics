...
class TestRePlayModelSupervisor extends BaseSpec {
    ...
    it should " Run LP from S3 and dispatching to kafka " in {
        ...
        RePlayModelSupervisor.main("LearnerProficiencySummary", "2016-02-15", "2016-02-16", JSONUtils.serialize(config));
    }
    ...
    it should " Run LAS from s3 data and dispatching to kafka " in {
        ...
        RePlayModelSupervisor.main("LearnerActivitySummary", "2016-02-15", "2016-02-22", JSONUtils.serialize(config));
    }
    ...
    it should " Run LCAS from s3 data and dispatching to kafka " in {
        ...
        RePlayModelSupervisor.main("LearnerContentActivitySummary", "2016-02-01", "2016-02-10", JSONUtils.serialize(config));
    }
    ...
    it should " Run RE from S3 and dispatching to kafka " in {
        ...
        RePlayModelSupervisor.main("RecommendationEngine", "2016-02-15", "2016-02-16", JSONUtils.serialize(config));
    }
