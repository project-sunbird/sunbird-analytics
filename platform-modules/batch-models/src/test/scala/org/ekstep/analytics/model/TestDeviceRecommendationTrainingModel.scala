...
class TestDeviceRecommendationTrainingModel extends SparkSpec(null) {
    ...
    def populateDB() {
        ...
        CassandraConnector(sc.getConf).withSessionDo { session =>
            ...
            session.execute("INSERT INTO local_device_db.device_content_summary_fact(device_id, content_id, app_id, channel, avg_interactions_min, download_date, downloaded, game_ver, last_played_on, mean_play_time_interval, num_group_user, num_individual_user, num_sessions, start_time, total_interactions, total_timespent) VALUES ('9ea6702483ff7d4fcf9cb886d0ff0e1ebc25a043', 'domain_68601','Genie','Ekstep', 10.0, 1475731808000, false, null, 1452038407000, 0, 0, 1, 1, 1475731808000, 20, 20);");
            session.execute("INSERT INTO local_device_db.device_content_summary_fact(device_id, content_id, app_id, channel, avg_interactions_min, download_date, downloaded, game_ver, last_played_on, mean_play_time_interval, num_group_user, num_individual_user, num_sessions, start_time, total_interactions, total_timespent) VALUES ('9ea6702483ff7d4fcf9cb886d0ff0e1ebc25a044', 'domain_63844','Genie','Ekstep', 2.0, 1452038407000, true, null, 1475731808000, 1, 10, 20, 100, 1459641600000, 1534, 124);");
            session.execute("INSERT INTO local_device_db.device_content_summary_fact(device_id, content_id, app_id, channel, avg_interactions_min, download_date, downloaded, game_ver, last_played_on, mean_play_time_interval, num_group_user, num_individual_user, num_sessions, start_time, total_interactions, total_timespent) VALUES ('9ea6702483ff7d4fcf9cb886d0ff0e1ebc48a084', 'domain_63333','Genie','Ekstep', 100.0, 1475731808000, false, null, 1452038407000, 0, 0, 1, 1, 1452038407000, 10, 20);");
