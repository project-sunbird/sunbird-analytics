...
class TestModels extends BaseSpec {
    ...
    "Models" should "create model objects for raw event" in {
        ...
        val event = new Event("OE_TEST", "2015-09-23T09:32:11+05:30", 0L, "2015-09-23T09:32:11+05:30", "1.0", gdata, "569b2478-c8da-4e21-8887-a0dfc2b47d7a", "569b2478-c8da-4e21-8887-a0dfc2b47d7a", "569b2478-c8da-4e21-8887-a0dfc2b47d7a", Option("Genie"),Option("Ekstep"), edata)
