...
case class EventId(eventType: String, searchType: String, saveType: String, fetchConfig: FetchConfig, filterMapping: Map[String, Filter], saveConfig: SaveConfig, localPath: String = "/mnt/data/analytics/dataexhaust")
