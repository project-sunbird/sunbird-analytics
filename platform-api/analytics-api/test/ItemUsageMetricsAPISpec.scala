...
class ItemUsageMetricsAPISpec extends BaseSpec {
	
	val apiURL = "/metrics/item-usage";
	
	"Item Usage Metrics API" should new WithApplication {
		"return error response when, there is invalid request"  in {
			val request = """{"id":"ekstep.analytics.metrics.item-usage","ver":"1.0","ts":"2016-09-12T18:43:23.890+00:00","params":{"msgid":"4f04da60-1e24-4d31-aa7b-1daf91c46341"},"request":{"filter":{"tag":"4f04da60-1e24-4d31-aa7b-1daf91c46341","content_id":"do_435543"}}}""";
