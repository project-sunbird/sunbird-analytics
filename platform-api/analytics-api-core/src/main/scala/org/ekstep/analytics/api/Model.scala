...
case class ContentPopularityMetrics(d_period: Option[Int] = None, label: Option[String] = None, m_downloads: Option[Long] = Option(0), m_side_loads: Option[Long] = Option(0), m_ratings: Option[List[(Double, DateTime)]] = Option(List()), m_avg_rating: Option[Double] = Option(0.0)) extends Metrics;
