...
case class DeviceMetrics(override val d_period: Option[Int] = Option(0), label: Option[String] = None, first_access: Option[Long] = Option(0), last_access: Option[Long] = Option(0), total_ts: Option[Double] = Option(0.0), total_launches: Option[Long] = Option(0), avg_ts: Option[Double] = Option(0.0), spec: Option[Map[String, AnyRef]] = Option(Map())) extends Metrics
