...
case class ContentUsageListMetrics(d_period: Option[Int] = None, val label: Option[String] = None, val m_contents: Option[List[AnyRef]] = Option(List()), val content: Option[List[AnyRef]] = Option(List())) extends Metrics;
